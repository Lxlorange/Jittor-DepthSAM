...
class MaskDecoder(nn.Module):
    ...
    def execute(
        ...
        Arguments:
          image_embeddings (jt.Var): the embeddings from the image encoder
          image_pe (jt.Var): positional encoding with the shape of image_embeddings
          sparse_prompt_embeddings (jt.Var): the embeddings of the points and boxes
          dense_prompt_embeddings (jt.Var): the embeddings of the mask inputs
