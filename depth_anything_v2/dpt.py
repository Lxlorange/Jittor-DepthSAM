...
class DPTHead(nn.Module):
    ...
    def execute(self, out_features, patch_h, patch_w):
        ...
        out = nn.interpolate(out, (int(patch_h * 14), int(patch_w * 14)), mode="bilinear", align_corners=True)
...
class DepthAnythingV2(nn.Module):
    ...
    def execute(self, x):
        ...
        depth,fts = self.depth_head(features, patch_h, patch_w)
        depth = nn.relu(depth)
